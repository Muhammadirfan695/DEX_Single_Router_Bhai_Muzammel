...
contract ERC721A is
    ...
    uint256 internal currentIndex = 139;
...
contract WASSER is ERC721A, Ownable, Pausable, ReentrancyGuard{
    ...
    uint256 price1   = 500;
    uint256 price2_1 = 250;
    uint256 price2_2 = 250;
    uint256 price3   = 400;
    uint256 price4   = 250;
    uint256 price5_1 = 400;
    uint256 price5_2 = 100;
